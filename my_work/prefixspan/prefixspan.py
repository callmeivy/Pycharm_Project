...
if __name__ == "__main__":
    ...
    patterns = prefixSpan(SquencePattern([], sys.maxint), S, 5)
    # ind=0
    # print ind
    # ind+=1
    patterns=[p for p in patterns if len(p.squence) >=2]
    patterns = sorted(patterns, key=lambda p: p.support, reverse = True)
