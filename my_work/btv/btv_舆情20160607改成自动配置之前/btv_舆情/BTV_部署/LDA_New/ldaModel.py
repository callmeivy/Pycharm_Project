...
def excuteldamodel(baseurl,mysqlhostIP, how_many_topics, how_many_iteration, how_many_topic_words, mysqlUserName = 'root', mysqlPassword = '', dbname = 'btv'):
            ...
            for cell in row['Cell']:
                ...
                if columnname == "'base_info:title'":
                    ...
                    if title == str(i):
                        ...
                        tempInsert_topic_title.append(1)
                        # 新闻插入表格的时间
...
if __name__=='__main__':
    ...
    excuteldamodel(hbaseIP = '192.168.168.41', mysqlhostIP = '10.3.3.182', how_many_topics = 5, how_many_iteration = 100, how_many_topic_words = 8, dbname = 'btv')