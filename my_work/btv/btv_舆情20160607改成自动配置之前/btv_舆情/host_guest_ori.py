...
def addhost_guest(baseurl,mysqlhostIP, fan_number_weight, weibo_number_weight, repost_number_weight, comment_number_weight, like_number_weight, mysqlUserName = 'root', mysqlPassword = '', dbname = 'btv_v2'):
    ...
    print today
    sqlcursor.execute("""update host_popularity set created_date = %s""",(now,))
...
if __name__=='__main__':
    commentTest = addhost_guest(baseurl = "http://172.28.12.34:8080", mysqlhostIP = '172.28.34.16', fan_number_weight = '0.3', weibo_number_weight = '0.05', repost_number_weight = '0.25', comment_number_weight = '0.3', like_number_weight = '0.1', dbname = 'btv_v2')
