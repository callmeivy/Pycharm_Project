...
'''
Created on 6.23
小朱把收视率的数据全拆开了，这样就没有list的情况了
此代码抓取收视率表中的每一个收视时段，同时将一天中的时间切分到分的层面，对应建立一个1440维的向量，
并将每一个收视时段对应到向量上，出现一整分钟的就加1
共耗时： 3:29:15.908000
共耗时： 0:39:12.503000
@author: Jin
'''
...
iae_audiencerate_new=conn.gehua.audiencerate_20150515
# index = iae_audiencerate_new.ensure_index("WIC.date")
# index2 = iae_audiencerate_new.ensure_index("WIC.A.n")
...
# channel = ['BTV科教','CCTV-13 新闻','兵团卫视','女性时尚','风云剧场','河南卫视','金鹰卡通','篮球','CHC动作电影','辽宁卫视高清','全纪实','湖北卫视','家庭理财','风尚购物','劲爆体育','江西卫视','东方购物','第一剧场','CCTV1综合高清','黑龙江卫视高清','BTV文艺','国防军事','广东卫视','优漫卡通','东方卫视','环球奇观','央视文化精品','四海钓鱼','新科动漫','置业频道','CHC高清电影','靓妆','电视指南','CCTV-14 少儿','新疆卫视','云南卫视','宁夏卫视','BTV生活','天津卫视','京视剧场','早期教育','BTV北京卫视高清','西藏卫视','BTV体育高清','嘉佳卡通','财富天下','家家购物','青海卫视','中国气象频道','安徽卫视高清','爵士音乐','法治天地','山西卫视','新娱乐','吉林卫视','浙江卫视','风云足球','深圳卫视高清','湖北卫视高清','书画频道','快乐宠物','BTV青年','广东卫视高清','山东卫视','辽宁卫视','福建东南卫视','高尔夫.网球','BTV文艺高清','深圳卫视','都市剧场','百姓健康','BTV影视','CCTV-NEWS','东方卫视高清','广西卫视','黑龙江卫视','时代美食','旅游卫视','生活时尚','BTV KAKU少儿','欢笑剧场','陕西卫视','东方财经','江苏卫视高清','内蒙古卫视','重庆卫视高清','环球购物','车迷频道','BTV北京卫视','CCTV-7 军事农业','湖南卫视高清','CCTV-6 电影','甘肃卫视','发现之旅','CCTV-9 纪录','CCTV-8 电视剧','CCTV-3 综艺','BTV财经','CCTV-2 财经','七彩戏剧','CCTV-5 体育','家有购物','贵州卫视','厦门卫视','CCTV3综艺高清','CCTV-1 综合','现代女性','优优宝贝','CCTV5体育高清','CCTV5+体育赛事','河北卫视','快乐购物','极速汽车','环球旅游','重庆卫视','湖南卫视','证券资讯','老故事']
# 挑选出来的145个频道，都是800以下的
# channel = ['203','657','227','606','633','218','242','608','183','109','135','254','174','195','189','124','233','258','253','114','201','653','219','245','130','148','131','140','132','144','198','204','106','142','103','133','194','146','139','166','211','255','149','638','216','179','235','156','217','185','251','137','601','643','102','145','186','197','181','263','143','118','196','120','617','250','138','134','170','172','177','107','161','111','267','621','190','626','199','314','209','176','241','637','67','225','167','191','164','182','141','665','654','243','192','108','651','169','163','184','136','622','210','222','311','104','129','634','187','165','202','188','221','110','226','168','215','632','175','642','244','116','101','127','631','126','178','260','237','128','123','105','122','223','125','247','173','193','603','121','262','117','605','162','268','224','119','171','180','212','240']
# channel = ['BTV文艺','国防军事','广东卫视','优漫卡通','东方卫视','环球奇观','央视文化精品','四海钓鱼','新科动漫','置业频道','CHC高清电影','靓妆','电视指南','CCTV-14 少儿','新疆卫视','云南卫视','宁夏卫视','BTV生活','天津卫视','京视剧场','早期教育','BTV北京卫视高清','西藏卫视','BTV体育高清','嘉佳卡通','财富天下','家家购物','青海卫视','中国气象频道','安徽卫视高清','爵士音乐','法治天地','山西卫视','新娱乐','吉林卫视','浙江卫视','风云足球','深圳卫视高清','湖北卫视高清','书画频道','快乐宠物','BTV青年','广东卫视高清','山东卫视','辽宁卫视','福建东南卫视','高尔夫.网球','BTV文艺高清','深圳卫视','都市剧场','百姓健康','BTV影视','CCTV-NEWS','东方卫视高清','广西卫视','黑龙江卫视','时代美食','旅游卫视','生活时尚','BTV KAKU少儿','欢笑剧场','陕西卫视','东方财经','江苏卫视高清','内蒙古卫视','重庆卫视高清','环球购物','车迷频道','BTV北京卫视','CCTV-7 军事农业','湖南卫视高清','CCTV-6 电影','甘肃卫视','发现之旅','CCTV-9 纪录','CCTV-8 电视剧','CCTV-3 综艺','BTV财经','CCTV-2 财经','七彩戏剧','CCTV-5 体育','家有购物','贵州卫视','厦门卫视','CCTV3综艺高清','CCTV-1 综合','现代女性','优优宝贝','CCTV5体育高清','CCTV5+体育赛事','河北卫视','快乐购物','极速汽车','环球旅游','重庆卫视','湖南卫视','证券资讯','老故事']
# 完整频道号，包括800以上的
# channel = ['620 ','124 ','108 ','101 ','149 ','182 ','104 ','121 ','617 ','133 ','103 ','621 ','165 ','633 ','148 ','634 ','643 ','218 ','653 ','176 ','131 ','109 ','605 ','134 ','123 ','137 ','232 ','237 ','210 ','126 ','174 ','216 ','107 ','189 ','212 ','125 ','183 ','166 ','102 ','122 ','180 ','187 ','105 ','250 ','201 ','199 ','132 ','682 ','601 ','135 ','626 ','178 ','169 ','168 ','127 ','141 ','128 ','170 ','234 ','186 ','181 ','117 ','606 ','110 ','631 ','161 ','608 ','153 ','665 ','106 ','163 ','139 ','173 ','114 ','136 ','632 ','172 ','235 ','171 ','142 ','262 ','130 ','619 ','215 ','193 ','211 ','622 ','415 ','223 ','603 ','195 ','638 ','220 ','246 ','314 ','258 ','145 ','657 ','167 ','185 ','154 ','129 ','184 ','188 ','179 ','243 ','175 ','151 ','242 ','57 ','247 ','197 ','140 ','901 ','253 ','144 ','-1 ','162 ','226 ','217 ','222 ','637 ','244 ','194 ','254 ','642 ','113 ','221 ','590 ','240 ','902 ','177 ','118 ','190 ','245 ','255 ','112 ','906 ','241 ','909 ','802 ','224 ','208 ','402 ','263 ','164 ','116 ','654 ','251 ','143 ','1281 ','55 ','219 ','198 ','233 ','405 ','156 ','155 ','146 ','561 ','68 ','907 ','1282 ','225 ','651 ','205 ','413 ','916 ','420 ','65 ','683 ','911 ','115 ','312 ','239 ','227 ','416 ','138 ','908 ','192 ','910 ','268 ','803 ','202 ','200 ','206 ','686 ','119 ','238 ','903 ','209 ','58 ','599 ','260 ','203 ','111 ','267 ','60 ','804 ','915 ','761 ','904 ','594 ','204 ','196 ','311 ','61 ','56 ','120 ','64 ','914 ','51 ','62 ','63 ','54 ','801 ','191 ','67 ','913 ','52 ','66 ','905 ','912 ','419 ','685 ','59 ','681 ','53 ','684 ','431 ','753 ','403 ','407 ','592 ','421 ','401 ','412 ','595 ','1 ','428 ','408 ','406 ','755 ','429 ','31 ','414']
# channel = ['620','124','108','101','149','182','104','121','617','133','103','621','165','633','148','634','643','218','653','176','131','109','605','134','123','137','232','237','210','126','174','216','107','189','212','125','183','166','102','122','180','187','105','250','201','199','132','682','601','135','626','178','169','168','127','141','128','170','234','186','181','117','606','110','631','161','608','153','665','106','163','139','173','114','136','632','172','235','171','142','262','130','619','215','193','211','622','415','223','603','195','638','220','246','314','258','145','657','167','185','154','129','184','188','179','243','175','151','242','57','247','197','140','901','253','144','-1','162','226','217','222','637','244','194','254','642','113','221','590','240','902','177','118','190','245','255','112','906','241','909','802','224','208','402','263','164','116','654','251','143','1281','55','219','198','233','405','156','155','146','561','68','907','1282','225','651','205','413','916','420','65','683','911','115','312','239','227','416','138','908','192','910','268','803','202','200','206','686','119','238','903','209','58','599','260','203','111','267','60','804','915','761','904','594','204','196','311','61','56','120','64','914','51','62','63','54','801','191','67','913','52','66','905','912','419','685','59','681','53','684','431','753','403','407','592','421','401','412','595','1','428','408','406','755','429','31','414']
channel = ['621']
# channel = ['浙江卫视']
...
mysqlcursor.execute('''CREATE TABLE IF NOT EXISTS audienceRate_min_0623(
...
for one_channel in channel:
    ...
    # print N
    lines=eval("iae_audiencerate_new.find({'date':'%s','n':'%s'}).batch_size(30)" %(date,str(one_channel)))
    ...
    # lines=eval("iae_audiencerate_new.find({'WIC.date':'%s','WIC.A.n':'%s'}).batch_size(30)" %(date,one_channel))
    # ccc = 0
    try:
        for line in lines:
            if line['n']== one_channel:
                # print 222222
                starttime=line['s']
                s_hour=int(starttime[0:2])
                # print "tttttttttttttttt",s_hour
    ...
    a = list(array)
    #
    sample_number = float(50000)/float(2)
    try:
    ...
    for element in a:
        ...
        mysqlcursor.executemany("insert into audienceRate_min_0623(date_time, minute_time, channel, tvRating) values (%s, %s, %s, %s)" , (insertList))
        mysqlconn.commit()
        count += 1
