...
输出：model.pkl 以及 vocabulary.pkl
'''
import MySQLdb
...
total = 3000
# sqlcursor.execute("SELECT concat(PubTitle,Storyline) as doc,tname from cctv_news_content order by rand() limit %s", (total,))
...
# vocabulary = classifier.named_steps['vectorizer'].vocabulary_
# save model
joblib.dump(classifier, 'E://model.pkl')
# joblib.dump(vocabulary, 'E://vocabulary.pkl')
