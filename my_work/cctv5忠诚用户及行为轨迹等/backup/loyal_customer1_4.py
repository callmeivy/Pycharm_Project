...
def behavior(mysqlhostIP, mysqlUserName = 'root', mysqlPassword = '', dbname = 'weibo'):
    ...
    for element in all_device_set:
        ...
        if times == 4:
            loyal_customer_4.append(element)
        elif times == 3:
            loyal_customer_3.append(element)
        elif times == 2:
            loyal_customer_2.append(element)
        elif times == 1:
            loyal_customer_1.append(element)

    print "4", len(loyal_customer_4)
    print "3", len(loyal_customer_3)
    print "2", len(loyal_customer_2)
    print "1", len(loyal_customer_1)
    sqlConn.close()
