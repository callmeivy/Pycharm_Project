...
def corpus_to_list():
    ...
    for one_type in category:
        ...
        excuteldamodel(mysqlhostIP='192.168.168.105', how_many_topics = 7, how_many_iteration=100, how_many_topic_words = 15,catcat = one_type,
                       dbname='cctv', )
...
# 以下是各个主题下新闻的列表
    ...
    for i, topic_dist in enumerate(topic_word):
        ...
        # 数据插入时间段
        tempInsert.append('20161001-20161231')
        # 数据插入时间
