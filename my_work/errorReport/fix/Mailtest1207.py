...
if __name__=='__main__':
    # a=Mailing(mailList = ['sunjian@ctvit.com.cn','zengchun@bgctv.com.cn','huangmeiying@bgctv.com.cn','fanxinwei@bgctv.com.cn','zhongjun@bgctv.com.cn','liqing@bgctv.com.cn','guxiaoliang@bgctv.com.cn','qifeng@bgctv.com.cn','wangyue1@bgctv.com.cn','tiansichang@bgctv.com.cn','zhaojian@bgctv.com.cn','dengbangzhong@bgctv.com.cn','8111@bgctv.com.cn','ts.gehua@xor-media.tv', 'yuanhao@ctvit.com.cn', "jincan@ctvit.com.cn"], localhost = "172.16.251.72", localuser = "",
    #           localpass = "", localprefix="")
    a=Mailing(mailList = ["jincan@ctvit.com.cn","lihuaqing@ctvit.com.cn"], localhost = "172.16.251.72", localuser = "",
              localpass = "", localprefix="")
    ...
    interday = datetime.timedelta(days=1)
    otherStyleTime = today - interday
    otherStyleTime=str(otherStyleTime)
    # otherStyleTime = time.strftime("%Y-%m-%d", otherStyleTime)
    # now = int(time.time())
