...
date_start={}
sum=0
mysqlcursor.execute('''select date,count(*) from servicetimeoutcount group by date order by date desc, serviceName asc''')
...
mysqlcursor.execute('''select date,serviceName,count,total from servicetimeoutcount order by date desc, serviceName asc ''')
...
##limit 28
mysqlcursor.execute('''select distinct (date) from servicetimeoutcount  order by date desc, serviceName asc''')
