...
class Mailing():
    ...
    def sendWithAttach(self, attachPath1, rename, sub, content):
        ...
        #发送邮件
        try:
            #timeout, or else stuck in the "connect" phrase below.!!!!!!!!!
...
if __name__=='__main__':
    a=Mailing(mailList = ['dongyuan@bgctv.com.cn','zengchun@bgctv.com.cn','huangmeiying@bgctv.com.cn','fanxinwei@bgctv.com.cn','zhongjun@bgctv.com.cn','liqing@bgctv.com.cn','guxiaoliang@bgctv.com.cn','qifeng@bgctv.com.cn','wangyue1@bgctv.com.cn','tiansichang@bgctv.com.cn','zhaojian@bgctv.com.cn','dengbangzhong@bgctv.com.cn','8111@bgctv.com.cn','ts.gehua@xor-media.tv', 'zhengxuehao@bgctv.com.cn', 'zhuyunlei@ctvit.com.cn', "jincan@ctvit.com.cn"], localhost = "172.16.251.72", localuser = "",
...
# 如果要跑昨天的代码，改这里%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fileName=r'/tmp/ErrorReportPro/errorReport/ERROR REPORT1_%s.zip'%otherStyleTime
    # fileName=r'/ERROR REPORT_%s.zip'%otherStyleTime
    print fileName
    #文件名不能有空格
    name_it='ERROR_REPORT_1_'+otherStyleTime+'.zip'
# ultraEdit
    count=1000
    while(count>0):
        ret = a.sendWithAttach(fileName, str(name_it), '点播错误报表统计1_'+otherStyleTime, '点播错误报表统计1_'+otherStyleTime+',请查收。')
        if ret>=1:
            print "succeed!"
            break
        else:
