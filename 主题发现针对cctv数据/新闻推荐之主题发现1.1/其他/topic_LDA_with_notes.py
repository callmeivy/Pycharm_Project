...
def corpus_to_list():
    ...
    for one_type in category:
        print one_type
        word_box = list()
        sqlcursor.execute("SELECT PubTitle,Storyline from cctv_news_content where tname like '%%%s%%' and ScriptCreateTime between '2016-10-01 00:00:00' and '2016-12-31 23:59:59';" %(one_type,))
